...
export class DriverLogin extends Component {
  ...
  sendInfo = async() => {
    ...
    if(res !== "__null") {
      if(res.drivID > 0) {
        ReactSession.set("drivID", res.drivID);
  ...
  render() {
    return(
        <div class="login">
            ...
            <TextField className='txtarea' {... this.errorAttr('phone')} name="phone" value={this.state.form.phone} label="Phone" type="text" onChange={this.updateState} /><br />
            <br />
